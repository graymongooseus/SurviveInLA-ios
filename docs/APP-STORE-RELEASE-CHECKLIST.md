...
- [x] 已选择 `Specific Countries or Regions`，首发开放 173 个市场。
...
- [x] 已上传 5 张 `1242 × 2688`、无透明通道的 iPhone 6.5 英寸截图；顺序为序章、地图、市场、打工结果、城市服务，并确认用于全部 iPhone 显示尺寸。
- [x] 已完成并保存简体中文应用描述、副标题、关键词、促销文本、版权信息和审核联系信息。
