...
当前旅行地点为：韩国城、时尚区、博伊尔高地、好莱坞、银湖、英格尔伍德、卡尔弗城、西木区、威尼斯和圣塔莫尼卡。十个地点统一为社区型市场，并分别拥有商品价格倾向；完整定位见 [地点设计](docs/LOCATIONS.md)。事件文本仍是便于替换的首版占位内容，后续可逐批改成洛杉矶故事。
