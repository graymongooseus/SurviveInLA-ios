<p align="center">
  <img src="docs/marketing/surviving-la-cover.png" alt="Surviving LA · 洛杉矶浮生记：一千美元起步，五十二周浮生。背着行囊的旅人站在暮色中的洛杉矶街头。" width="100%">
</p>
...
每周可以分别完成倒卖、打工和投资。打工与投资各只能结算一次，倒卖保留多次买卖；也可以放弃打工，在有住处时躺平休息，恢复 4 点健康。

| 你的选择 | 怎么赚钱 | 要付出什么 |
| --- | --- | --- |
| **倒卖 · 靠眼光** | 观察不同地区的报价，低价买入，带着库存寻找下一处卖点。 | 库存容量有限，行情随周刷新；等一个好价格，欠款也会继续涨。 |
| **打工 · 靠力气** | 做一份当地的现金工作，赚取工资，也可能遇到小费或扣款。 | 工作会消耗健康；也可用本周打工机会在家躺平，恢复 4 点健康。 |
| **投资 · 靠判断** | 选择当地的短期项目，投入现金，当周结算盈亏。 | 风险越高，结果越难预料；一次亏损就可能打乱还债计划。 |

**看行情 → 自由安排三类行动 → 结算这一周 → 面对新的局面。**
...
<p align="center">
  <a href="docs/app-store/screenshots/iphone-6.5-upload/01-opening.jpg"><img src="docs/app-store/screenshots/iphone-6.5-upload/01-opening.jpg" alt="游戏序章：没有回头路，现金 1,000 美元、欠款 5,000 美元、52 周求生" width="30%"></a>
  &nbsp;
  <a href="docs/app-store/screenshots/iphone-6.5-upload/02-map.jpg"><img src="docs/app-store/screenshots/iphone-6.5-upload/02-map.jpg" alt="游戏地图：从丁胖子广场出发，在倒卖、打工与投资之间选择" width="30%"></a>
  &nbsp;
  <a href="docs/app-store/screenshots/iphone-6.5-upload/03-market.jpg"><img src="docs/app-store/screenshots/iphone-6.5-upload/03-market.jpg" alt="游戏市场：查看本周商品报价与价格变化" width="30%"></a>
</p>
...
山火烟尘、酷热、堵在高速上的下午，或是餐馆后厨的一次意外，都可能改变你的安排。**56 条地区随机事件**与**7 个按固定周期间隔、随运气加权抽取的世界事件**，让同一条路线也能走出不同的结果。

多个世界事件可以同时生效，在一段时间内共同改变工资、行情、利息等规则。带油画插图的剧情弹窗，让一次数值变化成为你记得住的一段经历。
...
**当前开发版本：1.1（Build 3）。** [本次发布说明](docs/BUILD-3-CHANGELOG.md)。 运气、生活配置、多工种和分阶段人生选择已经进入可玩版本；专属事件与地点图片仍在分批补齐。

> 以下是 1.1 的实现范围。核心机制已完成首轮开发，具体数值与故事仍会根据真机试玩调整；图片全覆盖尚未完成。更新于 2026 年 9 月 5 日。

| 计划更新 | 你将体验到什么 |
| --- | --- |
| **美国生存路线** | 独立进度：租房 → 驾照 → 租车/买车 → 工具 → 物业 → HOPE。进度只随投入增长；完成后撑到第 52 周即可扎根洛杉矶，避开 ICE 遣返结局。 |
